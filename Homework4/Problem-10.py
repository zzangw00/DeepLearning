...
print(model.predict(np.array([400, 3.5, 5]).reshape(1, -1)))
print(model.predict(np.array([550, 3.8, 2]).reshape(1, -1)))
print(model.predict(np.array([700, 4.0, 2]).reshape(1, -1)))